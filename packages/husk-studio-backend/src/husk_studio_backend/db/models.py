...
class SpanRow(Base):
    ...
    input_inline: Mapped[dict[str, Any] | list[Any] | None] = mapped_column(JSON, nullable=True)
    output_ref: Mapped[str | None] = mapped_column(Text, nullable=True)
    output_inline: Mapped[dict[str, Any] | list[Any] | None] = mapped_column(JSON, nullable=True)
...
class SnapshotRow(Base):
    ...
    rng_state: Mapped[dict[str, Any] | None] = mapped_column(JSON, nullable=True)
...
class BranchRow(Base):
    ...
    override_payload: Mapped[dict[str, Any]] = mapped_column(JSON)
