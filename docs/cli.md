...
| `husk-ai demo` | Seed one IDE observability event plus a 3-span OTel trace with GenAI v1.36 attributes. Verify the Studio renders integration tiles and traces correctly before connecting your own agent. |
